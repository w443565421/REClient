...
QT_MOC_LITERAL(4, 31, 11) // "send_failed"
...
void SendThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->allowed((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->registered((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->send_failed(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SendThread::send_failed)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void SendThread::allowed(QString _t1)
{
