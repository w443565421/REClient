...
QT_MOC_LITERAL(1, 14, 16), // "strStatusChanged"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 21) // "on_pushButton_clicked"

    },
    "contentDialog\0strStatusChanged\0\0"
...
void contentDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        contentDialog *_t = static_cast<contentDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (contentDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&contentDialog::strStatusChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject contentDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_contentDialog.data,
      qt_meta_data_contentDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *contentDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_contentDialog.stringdata0))
        return static_cast<void*>(const_cast< contentDialog*>(this));
...
// SIGNAL 0
void contentDialog::strStatusChanged()
{
